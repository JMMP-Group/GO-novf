...
loc_file = "./bathymetry.loc_area-nord_ovf_025.dep2930_sig1_stn9_itr1.nc"
...
#ax.contour(lon, lat, bat, levels=[2800],colors='forestgreen',linewidths=10., transform=transform, zorder=4)
ax.contour(lon, lat, bat, levels=[2930],colors='forestgreen',linewidths=10., transform=transform, zorder=4)
