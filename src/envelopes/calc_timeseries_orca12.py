...
MAINdir = '/scratch/dbruciaf/GOSI-NOVF/'
#HPGElst = 'mes_u-dn502/r12_r16-r075-r040-r035-r030-r025-r020-r015_itr3'
#DOMCFG  = '/scratch/dbruciaf/GOSI10p3_12/r12_r16-r075-r040-r035-r030-r025-r020-r015_itr3/domain_cfg_12_MEs_novf_4env_2930_r12_r16-r075-r040-r035-r030-r025-r020-r015_itr3.nc'
HPGElst = 'mes_u-dn555/12_r16-r075-r040-r035-r030-r025-r020-r015_itr3-r010'
DOMCFG  = '/scratch/dbruciaf/GOSI10p3_12/r12_r16-r075-r040-r035-r030-r025-r020-r015_itr3-r010/domain_cfg_12_MEs_novf_4env_2930_r12_r16-r075-r040-r035-r030-r025-r020-r015_itr3-r010.nc'

loc_msk = '/data/users/dbruciaf/GOSI10_input_files/eORCA12/MEs_novf/bathymetry.loc_area-nord_ovf_12.dep2930_sig2_stn9_itr4.nc'
...
ds_loc = ds_loc.isel(x=slice(x1,x2), y=slice(y1,y2))
msk    = ds_loc['s2z_msk']
...
ds_dom = ds_dom.isel(x=slice(x1,x2), y=slice(y1,y2))
...
for F in range(len(Ufiles)):
    ...
    ds_U = ds_U.isel(x=slice(x1,x2), y=slice(y1,y2))
    ds_V = ds_V.isel(x=slice(x1,x2), y=slice(y1,y2))
    U4   = ds_U[Uvar]
    V4   = ds_V[Vvar]
